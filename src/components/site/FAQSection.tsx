...
const FAQS = [
  {
    ...
    a: "Yes! We deliver our authentic Filipino dishes including Chicken Inasal, Sisig, and BBQ across Kuwait City, Salmiya, Farwaniya, and surrounding areas. Our average delivery time is just 30 minutes."
  },
  {
