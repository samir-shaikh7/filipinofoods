...
// Pre-stringify FAQ schema to avoid re-computing on every render
...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-24 pt-8 pb-8 md:pt-12 md:pb-16 bg-white/50">
      <div className="mx-auto max-w-4xl px-4">
        ...
        {/* FAQ Schema — pre-computed at module level */}
        <script
