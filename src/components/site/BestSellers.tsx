                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    {m.variants && m.variants.length > 0 ? (
                      <Link 
                        to={`/product/${m.id}`}
                        className="flex h-11 items-center justify-center rounded-full bg-tropical/20 px-4 text-xs font-bold text-white transition hover:bg-tropical"
                      >
                        Options
                      </Link>
                    ) : (
