...
const PROMO_DISMISSED_KEY = "filipino_food_promo_dismissed";
...
export function PromoPopup() {
  ...
  useEffect(() => {
    // Skip fetching if user already dismissed the promo in this session
  ...
  const handleClose = () => {
    setIsOpen(false);
    // Remember dismissal for this session to avoid re-showing
              ...
              <div className="flex flex-col">
                {promo.image_url && (
                  <div className="relative aspect-video w-full overflow-hidden">
                    <img 
                      src={resolveImage(promo.image_url, 640)} 
                      alt={promo.title} 
