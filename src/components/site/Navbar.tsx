...
export function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "py-2" : "py-5"}`}
    >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="relative rounded-xl bg-muted/40 p-2.5 text-foreground transition-all duration-300 hover:bg-tropical/10 hover:text-tropical active:scale-95"
            ...
            <button
              className="rounded-xl bg-muted/40 p-2.5 lg:hidden transition-all active:scale-95"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 overflow-hidden rounded-xl shadow-soft">
                  <img src="/logo.jpeg" alt="Filipino Food" className="h-full w-full object-cover" />
                </div>
