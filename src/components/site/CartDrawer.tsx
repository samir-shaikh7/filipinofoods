                  ...
                  {items.map((i, idx) => (
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col justify-center pr-8">
                        <h4 className="font-semibold text-foreground/90 leading-tight line-clamp-1">{i.name}</h4>
                    ...
                    <div className="rounded-[2.5rem] bg-white p-6 shadow-elegant border border-white/50">
                      <div className="space-y-3 mb-6">
                        <div className="flex justify-between text-sm text-foreground/50">
                          <span>Subtotal</span>
                          <span className="font-semibold text-foreground/80">{CURRENCY}{formatPrice(total)}</span>
                        </div>
                        <div className="flex justify-between text-sm text-foreground/50">
                          <span>Delivery</span>
                          <span className="text-tropical font-semibold">Calculated on WhatsApp</span>
                        </div>
                        <div className="h-px w-full bg-muted/40 my-3" />
                        <div className="flex items-center justify-between text-xl font-bold">
                          <span>Total</span>
                          <span className="text-tropical">{CURRENCY}{formatPrice(total)}</span>
                        </div>
                      </div>

                      <button
                        onClick={() => setIsCheckout(true)}
                        className="flex w-full items-center justify-center gap-2 rounded-full gradient-tropical py-[18px] text-base font-bold text-white btn-glow shadow-glow"
                      >
                        Proceed to Checkout
                      </button>
