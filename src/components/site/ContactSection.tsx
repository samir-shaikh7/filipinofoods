...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 pt-8 pb-20 md:pt-12 md:pb-28">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 grid gap-3 md:gap-6 grid-cols-2">
            <div className="flex flex-col">
              <div className="mb-4 flex items-start gap-2 text-[9px] md:text-[11px] font-bold uppercase tracking-wider text-tropical min-h-[40px] md:min-h-[50px]">
                <span className="flex h-4 w-4 md:h-5 md:w-5 shrink-0 items-center justify-center rounded-full bg-mango text-[8px] md:text-[10px] text-white mt-0.5">1</span>
                <span>City Centre Salmiya Souk is located in Salmiya, Block 8, Al Khansa Street, 1st Floor Food Court</span>
              </div>
              <div className="overflow-hidden rounded-2xl md:rounded-[3rem] shadow-pop ring-1 ring-tropical/10 h-44 sm:h-64 md:h-80 w-full">
                <iframe
            ...
            <div className="flex flex-col">
              <div className="mb-4 flex items-start gap-2 text-[9px] md:text-[11px] font-bold uppercase tracking-wider text-tropical min-h-[40px] md:min-h-[50px]">
                <span className="flex h-4 w-4 md:h-5 md:w-5 shrink-0 items-center justify-center rounded-full bg-mango text-[8px] md:text-[10px] text-white mt-0.5">2</span>
                <span>Seafood Dynamite Kitchen Located in Salmiya, Block 2, on Salem Al Mubarak Street, First Mall, Mezzanine Floor</span>
              </div>
              <div className="overflow-hidden rounded-2xl md:rounded-[3rem] shadow-pop ring-1 ring-tropical/10 h-44 sm:h-64 md:h-80 w-full">
                <iframe
