...
export function FloatingButtons() {
  ...
  return (
    <div className="fixed bottom-28 right-4 z-[60] flex flex-col gap-3 md:bottom-8 [will-change:transform] [transform:translateZ(0)]">
      <a
        href={`https://wa.me/${contact.whatsapp?.replace(/\D/g, "")}?text=Hello,%20I%20have%20a%20question`}
        target="_blank"
        rel="noreferrer"
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-white text-mango shadow-pop transition hover:scale-110 hover:text-tropical"
        aria-label="Call"
      >
