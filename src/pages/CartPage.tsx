          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24">
            <div className="rounded-[2.5rem] bg-white p-8 shadow-elegant">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between text-foreground/50 font-bold">
                  <span>Delivery</span>
                  <span className="text-emerald-500 italic">Free in selected areas</span>
                </div>
                <div className="h-px w-full bg-border my-2" />
                <div className="flex justify-between text-3xl font-black">
                  <span>Total</span>
                  <span className="text-gradient-tropical">{CURRENCY}{formatPrice(total)}</span>
                </div>
              </div>
              ...
              {!isCheckout ? (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-full gradient-tropical py-5 text-lg font-bold text-white shadow-glow transition hover:scale-[1.02] active:scale-[0.98]"
                >
